...
import 'package:posyandu/home/data/view/lansia/detail_lansia.dart';

import '../../../../utils/apiservices.dart';
import '../../model/ibuhamil/ibu_model.dart';
import '../../model/lansia/lansia_model.dart';
import 'input_lansia.dart';

class Lansia extends StatefulWidget {
  const Lansia({Key? key}) : super(key: key);

  @override
  State<Lansia> createState() => _LansiaState();
}
...
class _LansiaState extends State<Lansia> {
  ...
  //         _listLansia =
  //             data.map((e) => LansiaModel.fromMap(e)).toList().reversed.toList();
  //       });
  //     }
  //   } catch (e) {
  //     print(e);
  ...
  deleteDataLansia(String id) async {
    try {
      ApiServices.post("elderlies/$id/delete", {}).then((value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => InputLansia()));
        },
        backgroundColor: Colors.blueAccent,
                ...
                Container(
                    ...
                    child: _listLansia.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemCount:
                                _listLansia.isEmpty ? 0 : _listLansia.length,
                            itemBuilder: (context, i) {
                              return Container(
                                  margin: EdgeInsets.only(top: 16),
                                  child: _buildList(
                                      _listLansia[i].name.toString(),
                                      _listLansia[i].age.toString(),
                                      _listLansia[i].id.toString()));
                            })),
              ],
            ),
          ),
