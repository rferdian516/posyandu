...
class InputKesehatanIbuHamil extends StatefulWidget {
  final String name;
  final String id;
  const InputKesehatanIbuHamil({Key? key, required this.name, required this.id})
      : super(key: key);

  @override
  State<InputKesehatanIbuHamil> createState() => _InputKesehatanIbuHamilState();
}

class _InputKesehatanIbuHamilState extends State<InputKesehatanIbuHamil> {
  ...
  inputDataKesehatan() async {
    try {
      ApiServices.post("monthly-healt-pregnant-womens/${widget.id}", {
        "pregnant-women": widget.id,
